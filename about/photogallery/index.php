...
?>
<a style="float:right;position:relative;z-index:1;" href="/about/photogallery/rss.php" title="RSS"><img width="14px" height="14px" alt="rss" src="/images/icon_rss.png"/></a>
<?$APPLICATION->IncludeComponent("bitrix:photogallery", ".default", array(
	"USE_LIGHT_VIEW" => "Y",
	"IBLOCK_TYPE" => "photovideogallery",
	"IBLOCK_ID" => "1",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/about/photogallery/",
	"CACHE_TYPE" => "A",
	"CACHE_TIME" => "3600",
	"USE_RATING" => "N",
	"SHOW_TAGS" => "N",
