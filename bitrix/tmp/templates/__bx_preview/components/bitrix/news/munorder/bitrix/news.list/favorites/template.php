...
<div class="news" id="news-container">
	<? $frame = $this->createFrame("news-container", false)->begin(); ?>
	<div id="newsList">
		...
		<? } else { ?>
			<p id="clearSelected"><a href="<?=$arParams["SEF_FOLDER"]?>addToSelected.php?clear=all" rel="nofollow">Очистить Избранное</a></p>
		<? } ?>
