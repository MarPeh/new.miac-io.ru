...
<?else:?>
	<input type="text" name="q" class="input" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
<?if($arParams["SHOW_WHERE"]):?>
	&nbsp;<select name="where" class="styler input-block">
...
<?endif;?>
	&nbsp;<input type="submit" class="btn btn-square" value="<?=GetMessage("SEARCH_GO")?>" />
...
<?else:?>
	<p class="alert alert-info"><?=GetMessage("SEARCH_NOTHING_TO_FOUND");?></p>
<?endif;?>
</div>