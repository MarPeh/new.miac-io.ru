...
if(CModule::IncludeModule("iblock")) {
    ...
    if ($_REQUEST["ELEMENT_ID"] > 0) {
        ...
        $APPLICATION->IncludeComponent("bitrix:news.detail", "service-detail", array(
            ...
            "IBLOCK_URL" => "#SITE_DIR#activity/gosserv/for/".$_REQUEST["FOR"]."/vedomstva/#SECTION_ID#/",
            "AJAX_MODE" => "N",
            "AJAX_OPTION_JUMP" => "N",
            "AJAX_OPTION_STYLE" => "Y",
            ...
            "USE_SHARE" => "N",
            "FOR_URL" => "#SITE_DIR#activity/gosserv/for/#FOR_ID#/",
            "MAIN_INFO_URL" => "#SITE_DIR#activity/gosserv/for/".$_REQUEST["FOR"]."/".$_REQUEST["MODE"]."/".$_REQUEST["SECTION_ID"]."/#ELEMENT_ID#/",
            ...
            <div class="tts-tabs-switchers-wrapper">
                <ul class="tts-tabs-switchers">
                    ...
                    while ($arRecipientType = $rsRecipientTypes->GetNext()) {
                        ...
                        if ($_REQUEST['FOR'] == $arRecipientType['ID'])
                        {
                            $APPLICATION->AddChainItem($arRecipientType['VALUE'], "#SITE_DIR#activity/gosserv/for/" . $arRecipientType['ID'] . "/");
                        }
                        ?>
                        <li class="tts-tabs-switcher<? echo ($_REQUEST['FOR'] == $arRecipientType['ID']) ? " active" : "" ?>" data-target-self="#SITE_DIR#activity/gosserv/for/<? echo $arRecipientType['ID'] ?>/"><? echo $arRecipientType['VALUE'] ?></li><?
                    }
                    ?>
                </ul>
            </div>
            <div class="tts-tabs-item padding-box active">
                <div class="btn-group col-margin-bottom">
                    ...
                    foreach ($modeList as $code => $caption) {
                        ...
                        {
                            $APPLICATION->AddChainItem($caption, "#SITE_DIR#activity/gosserv/for/". $_REQUEST["FOR"] ."/". $code ."/");
                        }
                        ?>
                        <a class="btn btn-outline btn-square<?echo $_REQUEST["MODE"] == $code ? " active" : "" ?>" href="#SITE_DIR#activity/gosserv/for/<?echo $_REQUEST["FOR"] ?>/<?echo $code ?>/"><?echo $caption?></a>
                        <?
                    }
                    ?>
                </div>
                ...
                if($_REQUEST["MODE"] === "category" && empty($_REQUEST["SECTION_ID"])) {
                    $GLOBALS['CATEGORY_FILTER'] = Bitrix\GosSite\Tools::getServicesCatsFilter("#GOSSERV_IBLOCK_ID#", $_REQUEST["FOR"]);
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "CHECK_DATES" => "Y",
                            "DETAIL_URL" => "#SITE_DIR#activity/gosserv/for/".$_REQUEST["FOR"]."/category/#ELEMENT_ID#/",
                            "AJAX_MODE" => "N",
                            "AJAX_OPTION_JUMP" => "N",
                            "AJAX_OPTION_STYLE" => "Y",
                            "AJAX_OPTION_HISTORY" => "N",
                    ...
                    $APPLICATION->IncludeComponent("bitrix:catalog.section.list", "services-department", array(
                        ...
                        "SECTION_URL" => "#SITE_DIR#activity/gosserv/for/".$_REQUEST["FOR"]."/vedomstva/#SECTION_ID#/",
                        "CACHE_TYPE" => "A",
                        "CACHE_TIME" => "36000000",
                        "CACHE_GROUPS" => "Y",
                        "ADD_SECTIONS_CHAIN" => "Y",
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "CHECK_DATES" => "Y",
                            "DETAIL_URL" => "#SITE_DIR#activity/gosserv/for/".$_REQUEST["FOR"]."/".$_REQUEST["MODE"]."/#SECTION_ID#/#ELEMENT_ID#/",
                            "AJAX_MODE" => "N",
                            "AJAX_OPTION_JUMP" => "N",
                            "AJAX_OPTION_STYLE" => "Y",
                            "AJAX_OPTION_HISTORY" => "N",
