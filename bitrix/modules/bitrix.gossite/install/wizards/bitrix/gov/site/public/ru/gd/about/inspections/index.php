...
<?$APPLICATION->IncludeComponent("bitrix:news", "list", array(
	...
	"CHECK_DATES" => "Y",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "#SITE_DIR#about/inspections/result/",
	"AJAX_MODE" => "N",
	...
	"PAGER_TITLE" => "Результаты проверок",
	"PAGER_SHOW_ALWAYS" => "N",
	"PAGER_TEMPLATE" => "",
