...
if(!CModule::IncludeModule("iblock"))
	return;
$iblockCode = "departmentsZags_".WIZARD_SITE_ID;
...
if ($iblockID)
{
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."department/index.php", array("DEPARTMENT_IBLOCK_ID" => $iblockID));
    return;
}

$iblockID = WizardServices::ImportIBlockFromXML(
	WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/department.xml", 
	"gossite_departmentsZags",
	$iblockType,
	WIZARD_SITE_ID, 
	$permissions = Array(
		"1" => "X",
...
$arProperties = Array("ADDRESS", "PHONE");
...
WizardServices::SetIBlockFormSettings($iblockID, Array ( 'tabs' => GetMessage("W_IB_DEPARTMENT_TABS1", array(
