...
$APPLICATION->SetTitle("Сми о нас");$APPLICATION->SetPageProperty("show_timestamp_x", "N");
...
<br /><?$APPLICATION->IncludeComponent("bitrix:news", "list", array(
	...
	"CHECK_DATES" => "Y",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "#SITE_DIR#info/massmedia/",
	"AJAX_MODE" => "N",
	"AJAX_OPTION_JUMP" => "N",
	"AJAX_OPTION_STYLE" => "Y",
