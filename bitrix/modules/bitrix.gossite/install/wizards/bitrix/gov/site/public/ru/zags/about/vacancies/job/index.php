...
?>
<blockquote><b>Публикуются</b>: Сведения о вакантных должностях в управление по делам записи актов гражданского состояния;
  <br />
  <br />
</blockquote>
...
<?$APPLICATION->IncludeComponent("bitrix:news", "list", array(
	...
	"CHECK_DATES" => "Y",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "#SITE_DIR#about/vacancies/job/",
	"AJAX_MODE" => "N",
