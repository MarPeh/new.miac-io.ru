...
?>
<a style="float:right;position:relative;z-index:1;" href="#SITE_DIR#about/photogallery/rss.php" title="RSS"><img width="14px" height="14px" alt="rss" src="#SITE_DIR#images/icon_rss.png"/></a>
<?$APPLICATION->IncludeComponent("bitrix:photogallery", ".default", array(
	...
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "#SITE_DIR#about/photogallery/",
	"CACHE_TYPE" => "A",
	"CACHE_TIME" => "3600",
	"USE_RATING" => "N",
	"SHOW_TAGS" => "N",
