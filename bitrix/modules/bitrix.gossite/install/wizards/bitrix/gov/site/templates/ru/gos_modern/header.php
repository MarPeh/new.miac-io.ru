    ...
    <div class="special-settings">
        <div class="container special-panel-container">
            <div class="content">
                ...
                <span class="aa-block"><a href="#SITE_DIR#?set-aa=normal" data-aa-off><i class="icon icon-special-version"></i> Обычная версия сайта</a></span>
            </div>
			...
			<div class="content">
                    ...
                    if ($GLOBALS["USER"]->IsAuthorized()) {
                        ...
                        <div class="top-header-nav">
                            <ul class="top-header-nav-ul">
                                <li class="parent">
                                    <a class="top-header-link" href="#SITE_DIR#personal/profile/"><i class="icon icon-lk"></i><span class="col-mb-hide col-hide col-dt-hide"> Мой профиль</span></a>
                                    <ul class="second-level">
                                        <li>
                                            <a href="#SITE_DIR#personal/profile/"> Изменить</a>
                                        </li>
                                        <li>
                                            <a href="#SITE_DIR#?logout=yes">Выйти</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        ?>
                        <a class="top-header-link" href="#SITE_DIR#auth/"><i class="icon icon-lk"></i><span class="col-mb-hide col-hide col-dt-hide"> Войти</span></a>
					    <?
                    }
                    $frame->end();
                    ?>
				...
				<div class="col col-mb-7 col-2 col-dt-2">
					<div class="top-header-right-side">
						<span class="aa-hide" itemprop="Copy"><a class="fl-r top-header-link ta-center" href="#SITE_DIR#?set-aa=special" data-aa-on><i class="icon icon-special-version"></i></a></span>
				...
				<div class="col col-mb-12 col-6 col-dt-3 mt10 col-margin-bottom">
                    <b><?$APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "#SITE_DIR#includes/top-address.php"
                        ),
                        false
                            ...
                            array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => "#SITE_DIR#includes/top-address-desc.php"
                            ),
                            false
                        );?></small>
				...
				<div class="col col-mb-12 col-6 col-dt-3 mt10 col-margin-bottom">
                    <b><?$APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "#SITE_DIR#includes/top-phone.php"
                        ),
                        false
                    );?></b><br><small class="text-light"><?$APPLICATION->IncludeComponent(
                            "bitrix:main.include",
                            ...
                            array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => "#SITE_DIR#includes/top-phone-desc.php"
                            ),
                            false
                        );?></small>
				</div> <!-- .col col-mb-12 col-6 col-dt-3 mt10 col-margin-bottom -->
