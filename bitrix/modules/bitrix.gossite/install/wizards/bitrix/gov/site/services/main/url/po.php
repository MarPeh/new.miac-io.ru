...
$arNewUrlRewrite=array(
	...
	array(
		"CONDITION"	=>	"#^".WIZARD_SITE_DIR."region/videogallery/([0-9]+)/#",
		"RULE"	=>	"ELEMENT_ID=$1&",
		"ID"	=>	"",
		"PATH"	=>	"".WIZARD_SITE_DIR."region/videogallery/index.php",
	),
	array(
	...
	array(
		'CONDITION' => '#^'.WIZARD_SITE_DIR.'region/photogallery/#',
		'RULE' => '',
		'ID' => 'bitrix:photogallery',
		'PATH' => ''.WIZARD_SITE_DIR.'region/photogallery/index.php',
	),
	array(
