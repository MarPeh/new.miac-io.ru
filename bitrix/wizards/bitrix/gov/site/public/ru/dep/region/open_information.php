...
<div> 
  <p>В настоящем разделе сайта опубликованы открытые данные Администрации города.</p>
  ...
  <p>Пользователь использует открытые данные на свой риск, при этом Администрация города ответственности не несет.</p>
