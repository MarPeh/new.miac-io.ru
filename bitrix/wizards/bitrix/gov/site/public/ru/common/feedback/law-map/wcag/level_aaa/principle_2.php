...
<table class="table table-responsive table-bordered">
	...
	<tr>
		<td>2.1.1-2.1.2</td>
		<td>Смотрите <a href="#SITE_DIR#feedback/law-map/wcag/level_a/principle_2.php">уровень А</a></td>
		<td></td>
	</tr>
	<tr>
		<td>2.1.3</td>
	...
	<tr>
		...
		<td><b>Вторичная авторизация</b>
			...
			<td><a href="#SITE_DIR#auth/">Авторизация</a>
				<br>
				<a href="#SITE_DIR#auth/?register=yes">Регистрация</a>
			</td>
	</tr>
	<tr>
		<th>2.3</th>
	...
	<tr>
		<td>2.4.5-2.4.7</td>
		<td>Смотрите <a href="#SITE_DIR#feedback/law-map/wcag/level_aa/principle_2.php">уровень АА</a></td>
		<td></td>
	</tr>
	<tr>
		<td>2.4.8</td>
