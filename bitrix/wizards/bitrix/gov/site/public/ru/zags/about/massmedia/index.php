...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"CHECK_DATES" => "Y",
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "#SITE_DIR#about/massmedia/",
		"AJAX_MODE" => "N",
		...
		"LIST_PROPERTY_CODE" => array(0=>"TIRASH",1=>"",),
		"HIDE_LINK_WHEN_NO_DETAIL" => "N",
		"DISPLAY_NAME" => "N",
		"META_KEYWORDS" => "-",
		"META_DESCRIPTION" => "-",
		"DETAIL_ACTIVE_DATE_FORMAT" => "d.m.Y",
		"DETAIL_FIELD_CODE" => array(0=>"",1=>"DATA",2=>"TIRASH",4 => "SHOW_COUNTER",
		5 => "DATE_CREATE",
		6 => "TIMESTAMP_X",),
		"DETAIL_PROPERTY_CODE" => array(0=>"TIRASH",1=>"",),
