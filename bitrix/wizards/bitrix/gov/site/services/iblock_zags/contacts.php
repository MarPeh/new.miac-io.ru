...
if ($iblockID)
{
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."contacts/index.php", array("CONTACTS_IBLOCK_ID" => $iblockID));
    return;
}

$iblockID = WizardServices::ImportIBlockFromXML(
	WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/contacts.xml", 
	"gossite_contacts",
	$iblockType,
	WIZARD_SITE_ID, 
	$permissions = Array(
