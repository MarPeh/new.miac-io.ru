...
$iblockCode = "benefits_".WIZARD_SITE_ID;
$iblockType = "benefits"; 
$iblockID = false;
...
if ($iblockID)
{
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/statistics/benefits/index.php", array("BENEFITS_IBLOCK_ID" => $iblockID));
    return;
}

$iblockXMLFile=WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID.'/benefits'.$benefits.'.xml'; 
