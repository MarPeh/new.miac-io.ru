...
$iblockCode = "normative_".WIZARD_SITE_ID;
$iblockType = "normative";
$iblockID = false;
...
if ($iblockID)
{
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.$normative."/index.php", array("NORMATIVE_IBLOCK_ID" => $iblockID));
    return;
}

$iblockID = WizardServices::ImportIBlockFromXML(
	WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID.'/regulatory/regulatory'.$regulatory.'.xml', 
	"gossite_normative",
	"normative",
	WIZARD_SITE_ID, 
	$permissions = Array(
