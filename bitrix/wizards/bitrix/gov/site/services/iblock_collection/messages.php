...
$iblockCode = "messages_".WIZARD_SITE_ID;
$iblockType = "news"; 
$iblockID = false;
...
if ($iblockID)
{
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."_index.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
	return;
}

$iblockXMLFile=WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID.'/messages/messages_'.$suffix.'.xml'; 
...
WizardServices::SetIBlockFormSettings($iblockID, array('tabs'=>GetMessage('MESSAGES_TABS_1').$VIDEO_PROPERTY_ID.GetMessage('MESSAGES_TABS_2').$PHOTOGALLERY_PROPERTY_ID.GetMessage('MESSAGES_TABS_3')));
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."_index.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/info/messages/index.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/info/messages/rss.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."news/messages/index.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."news/messages/rss.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."info/messages/index.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."info/messages/rss.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."bitrix/gadgets/gosportal/messagetslist/lang/ru/exec/index.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about-bitrix/journal_of_operations.php", array("MESSAGES_IBLOCK_ID" => $iblockID));
