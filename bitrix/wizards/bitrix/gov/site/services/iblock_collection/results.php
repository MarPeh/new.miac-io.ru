...
$iblockCode = "results_".WIZARD_SITE_ID;
$iblockType = "results";
$iblockID = false;
...
if ($iblockID)
{
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/inspections/index.php", array("RESULTS_IBLOCK_ID" => $iblockID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/inspections/rss.php", array("RESULTS_IBLOCK_ID" => $iblockID));
    return;
}

$iblockID = WizardServices::ImportIBlockFromXML(
	WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID.'/results/results_'.$suffix.'.xml', 
	"gossite_results",
	$iblockType,
	WIZARD_SITE_ID, 
	$permissions = Array(
