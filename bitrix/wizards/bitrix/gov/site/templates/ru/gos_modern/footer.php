                        ...
                        <div class="sidebar-content fz14">
                            <?$APPLICATION->IncludeComponent(
                                ...
                                array(
                                    ...
                                    "EDIT_TEMPLATE" => "",
                                    "PATH" => "#SITE_DIR#includes/about.php"
                                ),
                                false
                            );?>
                        </div>
			...
			<div class="col col-mb-12 col-4">
				<?$APPLICATION->IncludeComponent(
					...
					array(
						...
						"AREA_FILE_SUFFIX" => "inc",
						"EDIT_TEMPLATE" => "",
						"PATH" => "#SITE_DIR#includes/bottom-address.php"
					),
					false
				);?>
			</div> <!-- .col col-mb-12 col-4 -->
    ...
    <div class="mobile-nav">
        <div class="content p20 pb0">
            ...
            <div class="col col-mb-8 pl0">
                <a class="btn btn-square btn-dark btn-block" href="#SITE_DIR#personal/"><i class="icon icon-lk"></i> Личный кабинет</a>
            </div>
            <div class="col col-mb-4 pr0">
                <a class="btn btn-square btn-dark btn-block" href="#SITE_DIR#?logout=yes">Выйти</a>
            </div>
	        <? } else { ?>
		        <div class="col col-mb-8 pl0">
			        <a class="btn btn-square btn-dark btn-block" href="#SITE_DIR#auth/"><i class="icon icon-lk"></i> Авторизация</a>
		        </div>
	        <? } ?>
        </div>
    </div>
